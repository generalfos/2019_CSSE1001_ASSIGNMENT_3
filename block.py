...
BREAK_TABLES = {
    ...
    "diamond": {
        "hand": (10, False),
        "wood_pickaxe": (1.15, False),
        "stone_pickaxe": (0.6, False),
        "iron_pickaxe": (0.4, True),
    ...
    "gold": {
        "hand": (10, False),
        "wood_pickaxe": (1.15, False),
        "stone_pickaxe": (1.05, False),
        "iron_pickaxe": (0.7, True),
        "diamond_pickaxe": (0.13, True),
        "golden_pickaxe": (0.2, True)
    },
